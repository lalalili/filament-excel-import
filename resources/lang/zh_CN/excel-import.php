...
return [
    ...
    'preview_rows' => '数据预览',
    'preview_waiting_for_upload' => '上传文件后可预览前几行数据。',
    'preview_empty' => '上传文件中没有可预览的数据行。',
    'preview_unavailable' => '无法预览上传的文件。',
    ...
    'import_success' => '导入成功',
    'import_queued' => '导入已排入队列',

    // 成功消息
    'import_success_message' => '导入已成功完成',
    'import_queued_message' => '导入已排入队列，将在后台处理。',
